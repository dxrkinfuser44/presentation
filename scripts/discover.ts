      ...
      get: {
        ...
        responses: {
          "200": {
            ...
            content: {
              "application/json": { schema: { $ref: "#/components/schemas/Presentation" } },
            },
          },
        },
      },
    ...
    schemas: {
      Presentation: {
        ...
        properties: {
          ...
          subject: {
            type: "string",
            description: "e.g. PDHPE, Science, History, English, Commerce, Mathematics",
          },
          ...
          filePath: {
            type: "string",
            description: "Repo-relative file path, used for GitHub API submissions",
          },
...
const agentGuide = {
  version: "1.0.0",
  description:
    "Instructions for AI agents that want to read, create, or update presentations on this site.",

  reading: {
    summary:
      "Fetch manifest.json to get all presentations. Fetch /api/presentation/{id}.json for a single entry.",
  ...
  creating: {
    summary:
      "This site is static (GitHub Pages). To add a presentation, commit an HTML file to the repo using the GitHub Contents API.",
    steps: [
  ...
  htmlConventions: {
    ...
    structure:
      "Use a .deck container with .slide children. Each slide is full-viewport (100vw x 100vh). Navigation via keyboard (arrow keys) or click.",
    selfContained:
      "All CSS in a <style> tag in <head>. All JS in a <script> tag before </body>. No external files except Google Fonts CDN (acceptable).",
    slidePattern: `
<!-- Minimal skeleton: -->
<!doctype html>
<!--@presentation { ... } -->
<html lang="en">
  ...
  <body>
    ...
    `.trim(),
    agentHiddenComments:
      "You MAY include HTML comments throughout the file as agent-readable documentation. These are invisible to the human audience in the browser. Use them to document slide purpose, data sources, or instructions for future agents editing the file.",
  },
...
const aiPlugin = {
  ...
  description_for_model:
    "Access the presentations site API. Use listPresentations to see all available presentations. Read agent-guide.json for full instructions on creating new presentations via the GitHub API. The site is static — all write operations go through the GitHub Contents API.",
  api: {
    type: "openapi",
